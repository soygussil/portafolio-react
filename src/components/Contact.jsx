    ...
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/358f319d-16ad-4f95-b815-9becb286d781" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                ...
                <p className='text-gray-300 py-4'>// Submit the form below or shoot me an email - <a href="mailto: gussilv1995@gmail.com">gussilv1995@gmail.com</a></p>
            </div>
            ...
            <button className='text-white border-2 hover:bg-red-400 hover:border-red-400 px-4 py-3 my-8 mx-auto flex items-center'>Enviar Mensaje</button>
        </form>
    </div>
  )
}
